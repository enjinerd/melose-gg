...
export default function Features() {
  const Feature = (props: React.PropsWithChildren<{ icon: any; title: string; color: string }>) => {
    return (
      <Box>
        <Flex
          alignItems="center"
        ...
        <chakra.h3 mb={2} fontWeight="semibold" lineHeight="shorter" color={useColorModeValue('white', 'gray.200')}>
          {props.title}
        </chakra.h3>
    ...
    <Flex p={20} w="auto" justifyContent="center" alignItems="center">
      <Box px={8} py={20} mx="auto" bg={useColorModeValue('white', 'gray.800')}>
        <Box textAlign={{ lg: 'center' }}>
          <chakra.p mt={2} fontSize={{ base: '3xl', sm: '4xl' }} lineHeight="8" fontWeight="extrabold" letterSpacing="tight" color={useColorModeValue('white', 'gray.200')}>
            Features
          </chakra.p>
